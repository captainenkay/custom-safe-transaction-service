...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    # added
    EthereumNetwork.VIBI_2_MAINNET: [
        ("0xf5EF3316A06c9Fc722F4f6dB88152D98535953bD", 506, "1.4.1+L2"),
        ("0xadB5A59Edf4B72B472A21289dc203415B0E5A675", 505, "1.4.1"),
    ],
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    # added
    EthereumNetwork.VIBI_2_MAINNET: [
        ("0x6C3c1AF93Cdb9C3bB023626E45254F9bCbD93cd1", 497),  # v1.4.1
    ],
    EthereumNetwork.ENERGY_WEB_CHAIN: [
